return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_keymap("v", "gq", "<CMD>SearchReplaceSingleBufferVisualSelection<CR>", opts)
      vim.api.nvim_set_keymap("v", "g!q", "<CMD>SearchReplaceWithinVisualSelection<CR>", opts)
